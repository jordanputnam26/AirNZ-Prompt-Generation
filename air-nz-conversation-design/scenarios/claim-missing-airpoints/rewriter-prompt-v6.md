# rewriter-prompt-v6.md

## Status

Draft v6.

This is the sixth rewriter prompt draft. It shifts from a claim-specific rewriter to a general Air New Zealand servicing rewriter, with the active journey carried by the Service Agent block.
