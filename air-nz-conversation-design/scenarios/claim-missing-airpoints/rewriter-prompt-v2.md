# rewriter-prompt-v2.md

## Status

Draft v2.

This is the second rewriter prompt draft for the Air New Zealand `Claim Missing Airpoints` scenario. It is built from the Air NZ artefacts and scenario brief, not directly from raw workshop transcripts or Miro exports.
