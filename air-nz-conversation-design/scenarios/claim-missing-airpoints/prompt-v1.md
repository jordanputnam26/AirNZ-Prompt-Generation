...
This is the first prompt draft for the Air New Zealand `Claim Missing Airpoints` scenario. It is built from the Air NZ artefacts and scenario brief, not directly from raw workshop transcripts or Miro exports.
