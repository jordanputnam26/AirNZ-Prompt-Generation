...
This is the second prompt draft for the Air New Zealand `Claim Missing Airpoints` scenario. It is built from the Air NZ artefacts and scenario brief, not directly from raw workshop transcripts or Miro exports.

## Purpose

This prompt is for the customer-facing Air New Zealand servicing agent handling `Claim Missing Airpoints` conversations in authenticated digital chat.
...
- This version aims to keep the same operating logic while making Oscar more audible and reducing the internal-spec feel.
